...
import myImg from "../../Assets/marine.png";
...
function Home2() {
  return (
    <Container fluid className="home-about-section">
      <Container>
        <Row>
          {/* Avatar and Social Links on the Left */}
          <Col md={4} className="myAvtar order-md-1 order-2">
            <Tilt>
          ...
          {/* Text on the Right */}
          <Col md={8} className="home-about-description order-md-2 order-1">
            {/* Centered Heading */}
